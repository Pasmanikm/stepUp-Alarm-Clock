...
android {
    namespace = "com.example.stepupalarmclock"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.stepupalarmclock"
        minSdk = 30
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.google.android.horologist:horologist-composables:0.5.16")
